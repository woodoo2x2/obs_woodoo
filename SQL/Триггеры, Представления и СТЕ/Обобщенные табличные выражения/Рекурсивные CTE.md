...
```
 ...
 По умолчанию рекурсивный запрос в рекурсивном CTE может сгенерировать **не более** `1000` записей.
...
 Доступ к полям в рекурсивном запросе рекурсивного CTE осуществляется по имени, а не по положению.
